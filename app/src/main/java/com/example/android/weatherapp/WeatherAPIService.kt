...
import com.example.android.weatherapp.utilities.BASE_URL
...
interface WeatherApiService {
   ...
   suspend fun getCurrentWeather(@Query("q") cityName: String , @Query("appid") appId: String ): Response<CurrentWeatherModel>
    ...
    suspend fun getFiveDaysWeather(@Query("q") cityName: String , @Query("appid") appId: String ): Response<ForecastWeatherModel>
}
